...
| 명칭 | 경로 | 역할 | 정본 여부 |
|------|------|------|----------|
| **깃헙독스 (GitHub Docs)** | `.github/` | 개발 **프로세스** 표준 | ✅ 정본 |
| **레포독스 (Repo Docs)** | `docs/` | 개발 **결과물** 문서 | 보완 |

> **깃헙독스**만 있으면 **어떤 프로젝트든** SDD로 고품질 개발 가능  
...
👉 **[01-new-project.md](guides/01-new-project.md)** - 빈 폴더에서 시작

### 기존 프로젝트 마이그레이션

👉 **[02-migration.md](guides/02-migration.md)** - 기존 레포에 SDD 적용

### 새 개발자 온보딩

👉 **[04-onboarding.md](guides/04-onboarding.md)** - 팀 합류 시 필독

### 검증

```bash
# .github/scripts/ 에서 직접 실행 (권장)
