...
('PROJECT_DELIVERABLE_SUBMISSION_STATUS','submitted','제출됨','Submitted','내부 제출 또는 고객 전달 완료.',20),
('PROJECT_DELIVERABLE_SUBMISSION_STATUS','confirmed','확정','Confirmed','고객 검토 확정 완료.',30)
