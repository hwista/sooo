-- =========================================================
-- History Trigger: pr_project_status_m -> pr_project_status_h
...
-- 기존 트리거 삭제 후 재생성
DROP TRIGGER IF EXISTS trg_pr_project_status_h ON pr_project_status_m;

CREATE TRIGGER trg_pr_project_status_h
AFTER INSERT OR UPDATE OR DELETE ON pr_project_status_m
FOR EACH ROW EXECUTE FUNCTION fn_pr_project_status_h_trigger();

COMMENT ON FUNCTION fn_pr_project_status_h_trigger() IS '프로젝트 상태 히스토리 트리거 함수';
