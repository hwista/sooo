...
-- 시퀀스 (history_seq 생성용)
CREATE SEQUENCE IF NOT EXISTS cm_menu_h_seq;
...
-- 트리거 생성
DROP TRIGGER IF EXISTS tr_cm_menu_m_history ON cm_menu_m;
CREATE TRIGGER tr_cm_menu_m_history
    AFTER INSERT OR UPDATE OR DELETE ON cm_menu_m
