-- ============================================
-- cm_user_menu_r 히스토리 트리거
-- ============================================

-- 시퀀스 (history_seq 생성용)
CREATE SEQUENCE IF NOT EXISTS cm_user_menu_h_seq;
...
DECLARE
    v_event_type CHAR(1);
    v_record cm_user_menu_r%ROWTYPE;
BEGIN
...
-- 트리거 생성
DROP TRIGGER IF EXISTS tr_cm_user_menu_r_history ON cm_user_menu_r;
CREATE TRIGGER tr_cm_user_menu_r_history
    AFTER INSERT OR UPDATE OR DELETE ON cm_user_menu_r
