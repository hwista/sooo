  ...
  theme: {
    extend: {
      ...
      fontSize: {
        ...
        'action-md': ['0.8125rem', { lineHeight: '1.125rem', fontWeight: '500' }],
        ...
        'body-xs': ['0.8125rem', { lineHeight: '1.125rem', fontWeight: '400' }],
        caption: ['0.75rem', { lineHeight: '1rem', fontWeight: '400' }],
        'caption-2xs': ['0.6875rem', { lineHeight: '0.875rem', fontWeight: '500' }],
        'caption-xs': ['0.625rem', { lineHeight: '0.75rem', fontWeight: '500' }],
      ...
      colors: {
        ...
        ssoo: {
          ...
          danger: 'var(--ssoo-danger)',
          'danger-hover': 'var(--ssoo-danger-hover)',
          'danger-border': 'var(--ssoo-danger-border)',
          'danger-bg': 'var(--ssoo-danger-background)',
          warning: 'var(--ssoo-warning)',
          'warning-border': 'var(--ssoo-warning-border)',
          'warning-bg': 'var(--ssoo-warning-background)',
          success: 'var(--ssoo-success)',
          'success-border': 'var(--ssoo-success-border)',
          'success-bg': 'var(--ssoo-success-background)',
          info: 'var(--ssoo-info)',
          'info-border': 'var(--ssoo-info-border)',
          'info-bg': 'var(--ssoo-info-background)',
          accent: 'var(--ssoo-accent-tone)',
          'accent-border': 'var(--ssoo-accent-border)',
          'accent-bg': 'var(--ssoo-accent-background)',
          neutral: 'var(--ssoo-neutral)',
          'neutral-border': 'var(--ssoo-neutral-border)',
          'neutral-bg': 'var(--ssoo-neutral-background)',
        },
        ls: {
          blue: 'var(--ls-blue)',
          red: 'var(--ls-red)',
...
module.exports = ssooTailwindPreset;
