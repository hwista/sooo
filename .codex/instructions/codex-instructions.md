...
13. **사용자-visible 기능의 임의 제거/대체** - 명시 지시 없는 화면·버튼·복구 동선·상태 표현 제거는 Behavior Impact Gate 없이 수행 금지
...
| 날짜 | 변경 내용 |
|------|-----------|
| 2026-07-10 | Behavior Impact Gate 추가: 사용자-visible 기능·복구 동선은 dead code로 간주하지 않고 명시 지시 없는 삭제/대체 전 사용자 확정 게이트를 요구 |
