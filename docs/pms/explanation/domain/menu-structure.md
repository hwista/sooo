...
|------|------|-------------|------|
| 요청 | Request | `request` | 내부 접수 또는 CRM 인계 확인 |
| 제안 | Proposal | `proposal` | 실행 착수 전 범위 확인, CRM 제안 스냅샷 참조 |
...
| 요청 | Request | MessageSquare | 내부 접수, CRM 인계 확인 | CRM 기회 원장 편집 금지 |
| 제안 | Proposal | Lightbulb | 실행 전 범위 확인, CRM 제안 스냅샷 참조 | 견적/계약 편집 금지 |
...
3. **제안/범위 확인 단계 전환** → proposal + waiting
4. **CRM 확정/실행 인계 수령** → execution + waiting
...
| Date | Change |
|------|--------|
| 2026-07-06 | PMS 관리자 메뉴 기준에서 고객사 관리 화면을 제거했다. 고객사 원장 편집은 CRM/Admin/공용 조직 책임이며 PMS는 읽기 조회만 사용한다. |
| 2026-07-03 | 요청/제안 메뉴 설명을 CRM 분리 기준으로 현행화하고, PMS에서 견적/계약 원장을 편집하지 않는 기준을 명시했다. |
