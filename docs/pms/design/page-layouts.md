...
## 5. 상세 페이지 (DetailPageTemplate)

> 향후 구현 예정 - 상세 페이지도 동일한 구조 적용
...
<DetailPageTemplate
  ...
  header={{
    actions: [
      { label: '목록', icon: <ArrowLeft />, variant: 'outline', onClick: handleGoBack },
      { label: '수정', icon: <Edit />, variant: 'default', onClick: handleEdit },
      { label: '삭제', icon: <Trash />, variant: 'destructive', onClick: handleDelete },
    ],
  }}
>
  <PageContent>
    <DetailSection title="기본 정보">
      <DetailFields
        ...
        fields={[
          ...
          { label: '단계', value: <Badge>{getStageLabel(data.stageCode)}</Badge> },
