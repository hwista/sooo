...
|--------|-----|-----|------|----------|
| `next` | ^15.1.0 | 16.0.0 | ⚠️ 메이저 차이 | 검토 필요 |
| `react` | ^19.0.0 | 19.2.0 | ✅ 호환 | 19.x 유지 |
| `react-dom` | ^19.0.0 | 19.2.0 | ✅ 호환 | 19.x 유지 |
...
| `clsx` | ^2.1.0 | ^2.1.1 | ✅ 호환 |
| `tailwind-merge` | ^2.6.0 | ^3.3.1 | ⚠️ 메이저 차이 |
| `lucide-react` | ^0.468.0 | ^0.548.0 | ⚠️ 버전 차이 |
