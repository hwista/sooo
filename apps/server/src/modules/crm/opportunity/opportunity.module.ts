...
@Module({
  imports: [DatabaseModule, CommonAiIndexModule, UserModule, FileModule, TemplatesModule, DmsCrmQuoteLifecycleModule, DmsCrmOpportunityContractLifecycleModule, CrmAccessModule, ContractModule, QuoteSettingsModule, CrmOperationAttemptModule],
