...
const targets = [
  ...
  { uxId: 'UX-03', sourcePage: 'form', ownerSurface: 'CRM /?sourceSurface=form', baseUrl: crmBaseUrl, href: '/?sourceSurface=form&selected=crm-uiux-opp-001', readySelector: '[data-source-surface="form"]', readyValueSelector: '[data-source-surface="form"] #f-customer' },
